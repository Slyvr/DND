...
public class Ent {
	...
	public enum State {
		NORMAL, HOVER, CLICKED, JUMP, STAND, INJURED, DEAD, SELECTED
	}
	...
	public Ent(Ent ent) {
		...
		this.setImg(ent.getImg());
		this.setPosBox(new Rectangle(ent.getPosBox()));
		this.setType(ent.getType());
		this.setColor(ent.getColor());
		this.setState(ent.getState());
		this.setScaleX(ent.getScaleX());
		this.setScaleY(ent.getScaleY());
		this.setAnimSpeed(ent.getAnimSpeed());
		this.setCollisionBox(new Rectangle(ent.getCollisionBox()));
		this.setDisplay(ent.isDisplay());
	}
		...
		if (this.display){
			...
			if (this.getImg()!=null){
				if (this.getImg().getTexRegs() != null){
					this.getImg().setCurrentFrame(this.getImg().getAnim().getKeyFrame(Game.getGlobal().getStateTime(), true));
	...
	public void setValueByKey(String key, String value){
		...
		if (key.contains("_font")){
			this.font = Game.getGlobal().getFontByName(value);
		}
		if (key.contains("_text")){
			this.text = value;
		}
		if (key.contains("_img")){
			this.img = Game.getGlobal().getImgByName(value);
		}
